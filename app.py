...
class TraderView:
    ...
    def refresh(self):
    # force new trader object (fresh data loaded from DB)
        self.trader = Trader(self.trader.name, self.trader.lastname, self.trader.model_name)
...
def create_ui():
    ...
    with gr.Blocks(
        ...
        # inject CSS + JS correctly (universal method)
...
if __name__ == "__main__":
    ...
    from trading_floor import main_loop
